      ...
      <ContainerList>
        <div className=" flex space-x-5">
          ...
          <div className=" relative w-full">
            {!showIndustri ? (
              <div className=" w-full p-3 px-5 text-sm rounded border flex justify-between items-center " onClick={() => setShowIndustri(true)}>
                <span>Pilih Industri</span>
                <ArrowDown />
              </div>
            ) : (
              <div className=" absolute bg-white flex flex-col w-full border rounded top-0" onClick={() => setShowIndustri(false)}>
                ...
                <div className=" flex flex-col py-4">
                  <div className=" text-sm border-l-8 border-primary p-2 px-4 hover:border-primary cursor-pointer font-bold" onClick={() => setShowIndustri(false)}>Semua Industri</div>
                  <div className=" text-sm border-l-8 border-white p-2 px-4 hover:border-primary cursor-pointer text-gray-500" onClick={() => setShowIndustri(false)}>Seni & Kerajinan</div>
                  <div className=" text-sm border-l-8 border-white p-2 px-4 hover:border-primary cursor-pointer text-gray-500" onClick={() => setShowIndustri(false)}>Otomotif</div>
                  <div className=" text-sm border-l-8 border-white p-2 px-4 hover:border-primary cursor-pointer text-gray-500" onClick={() => setShowIndustri(false)}>Kecantikan</div>
                  <div className=" text-sm border-l-8 border-white p-2 px-4 hover:border-primary cursor-pointer text-gray-500" onClick={() => setShowIndustri(false)}>Layanan Bisnis</div>
                  <div className=" text-sm border-l-8 border-white p-2 px-4 hover:border-primary cursor-pointer text-gray-500" onClick={() => setShowIndustri(false)}>Anak-Anak</div>
                  <div className=" text-sm border-l-8 border-white p-2 px-4 hover:border-primary cursor-pointer text-gray-500" onClick={() => setShowIndustri(false)}>Kebersihan & Perawatan</div>
                  <div className=" text-sm border-l-8 border-white p-2 px-4 hover:border-primary cursor-pointer text-gray-500" onClick={() => setShowIndustri(false)}>Konstruksi</div>
                </div>
              </div>
            )}
          </div>
          ...
          <div className=" w-full">
            <button className=" w-full h-full text-sm font-bold bg-primary border border-primary rounded focus:outline-none duration-300 hover:bg-white">Cari Peluang Terbaik</button>
          </div>
        </div>
      </ContainerList>
      <ContainerList>
        <div className=" flex w-full">
          <div className=" w-1/4 pr-10">
            ...
            <div className=" relative mt-5">
              {!showTerverifikasi ? (
                <div className=" w-full p-2 px-5 text-sm rounded border flex justify-between items-center " onClick={() => setShowTerverifikasi(true)}>
                  <span>Terverifikasi</span>
                  <ArrowDown />
                </div>
              ) : (
                <div className=" absolute flex flex-col w-full border rounded top-0" onClick={() => setShowTerverifikasi(false)}>
                  ...
                  <hr />
                  <div className=" flex flex-col py-4">
                    <div className=" text-sm border-l-8 border-primary p-2 px-4 hover:border-primary cursor-pointer font-bold" onClick={() => setShowTerverifikasi(false)}>Terverifikasi</div>
