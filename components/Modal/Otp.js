    ...
    >
      ...
      >
        ...
        <div className=" p-12 px-24 flex flex-col items-center">
          ...
          <div className=" text-gray-400 text-sm font-light text-center mt-2">Masukkan kode verifikasi yang kami kirimkan ke email<br />{props.email}</div>
          <div className=" flex flex-col mt-4">
            ...
            <div className=" flex space-x-4 mt-5">
              <button
                ...
                type="btn"
                className={`${numOtp.length === 6 ? 'bg-black' : 'bg-slate-100'} 
