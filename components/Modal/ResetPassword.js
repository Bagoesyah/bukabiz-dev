  ...
  const login = () => {
    ...
    axios({
      ...
      .then(function (response) {
        setCookie(
          'user',
          compress(JSON.stringify(response.data.data.member))
        )
          ...
          {formOtp ? (
            ...
            <>
              ...
              <div className=" flex flex-col mt-4 relative">
                ...
                />
                <button onClick={() => setShowPass(!showPass)} className="cursor-pointer absolute right-3 top-7">
              ...
              <div className=" flex flex-col mt-4 relative">
                ...
                />
                <button onClick={() => setShowRePass(!showRePass)} className="cursor-pointer absolute right-3 top-7">
                  {showRePass ? <EyeClosed /> : <EyeOpen />}
                </button>
              </div>
              <div className=" flex space-x-4 mt-5">
                <div className=" py-2 px-12 text-white text-sm font-bold bg-black rounded cursor-pointer" onClick={submit}>
                  Simpan
                </div>
              </div>
            ...
            <>
              <ICLogo />
              <div className=" mt-12 text-2xl">Atur ulang kata sandi</div>
              <div className=" text-gray-400 text-sm font-light text-center mt-2">Masukkan e-mail yang terdaftar. Kami akan mengirimkan kode verifikasi<br />untuk atur ulang kata sandi.</div>
              ...
              <div className=" flex space-x-4 mt-5">
                <div className=" py-2 px-12 text-white text-sm font-bold bg-black cursor-pointer rounded" onClick={checkEmail}>
                  {loading ? 'loading ...' : 'Lanjut'}
                </div>
                <div className=" py-2 px-12 text-white text-sm font-bold bg-gray-500 cursor-pointer rounded" onClick={props.onClick}>
                  Batal
                </div>
              </div>
              <div className=" mt-20 text-sm font-light text-gray-400">
