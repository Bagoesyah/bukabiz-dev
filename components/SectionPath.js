...
function SectionPath({ path, title, count, desc, className }) {
  return (
    <section>
      <div className={`  flex justify-center ${className} ${title !== undefined ? 'pt-16' : 'pt-20'} `}>
        ...
        <div className=" flex flex-col justify-center items-center text-center py-8 space-y-3">
          ...
          >
            ...
            {!desc ? (
              ...
              <p>Temukan di sini peluang usaha yang mungkin cocok untuk kamu. Kamu bisa pilih sesuai <b>kategori industri</b>,< br />
                <b>lokasi bisnis</b>, <b>bentuk kemitraan</b> sampai <b>biaya investasi</b> yang sesuai dengan kantongmu
              </p>
            )}
          </AnimatePulse>
        </div>
